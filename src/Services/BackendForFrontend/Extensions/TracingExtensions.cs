...
namespace BackendForFrontend.Extensions;
...
public static class TracingExtensions
{
    public static IServiceCollection AddTracingSupport(this IServiceCollection services, TracingOptions options)
    {
            ...
            .AddSource("Custom")
            .AddConsoleExporter()
            .SetResourceBuilder(ResourceBuilder.CreateDefault().AddService(serviceName: options.ServiceName, serviceVersion: options.ServiceVersion))
